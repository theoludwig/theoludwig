...
I plan to publish new posts when I have something new to share, at most one post per week.

As an example there might be new posts 2 weeks in a row and then 2 months with nothing new. There's no schedule, so stay tuned!
...
**Side note:** I am still working on [Thream](https://thream.divlo.fr/), your open source platform to stay close with your friends and communities, talk, chat, collaborate, share and have fun.
It takes more time to develop it than expected, but we'll get there! 😊
